...
import NodeJSImg from "@/public/ReactJS_img.png";
  ...
  return (
    <>
      ...
      <Image
        ...
        className="w-[100vw] my-10"
        unoptimized
      />
      {/* Characteristics Cards */}
      <div className="p-5">
        <h3 className="text-primary-color text-5xl text-center font-bold mb-10">
          Unique <span className="text-black">Qualities</span>
        </h3>
        <div className="flex justify-between">
          <div className="border shadow-lg rounded-3xl max-w-[350px]">
            <Image
              src={LeadershipChar1}
              width={100}
              height={100}
