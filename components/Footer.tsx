  ...
  return (
    <div className="block rounded-tl-3xl rounded-tr-3xl bg-light-black text-white px-20 max-sm:px-10 py-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div>
          <button className="rounded-full bg-primary-color py-1 px-4 text-2xl flex items-center font-medium">
            <p>Hire me </p>
            <svg
              width="40"
              height="40"
      ...
      <div className="md:grid lg:grid-cols-5 max-lg:grid-cols-3 justify-items-center gap-2">
        <div className="col-span-2">
          <div className="flex items-center gap-1 cursor-pointer mb-8">
          ...
          <div className="flex mt-5 gap-1 mb-5">
            <svg
              width="24"
              height="25"
              viewBox="0 0 24 25"
        ...
        <div className="text-xl flex flex-col">
          ...
          <Link href="/services" className="mb-5">
            Service
          </Link>
          <Link href="/resume" className="mb-5">
            Resume
          </Link>
          <Link href="/projects" className="mb-5">
            Project
          </Link>
        </div>
        <div className="text-xl flex flex-col">
