    ...
    <div className="block rounded-tl-3xl rounded-tr-3xl bg-light-black text-white lg:px-20 md:px-10 px-5 pt-10 pb-6">
      ...
      <div className="md:grid lg:grid-cols-5 lg:justify-items-center max-lg:grid-cols-3 justify-around gap-2 md:gap-10">
        ...
        <div className="text-xl flex flex-col">
          ...
          </m.div><m.div whileHover={{scale: 1.1}} className="mb-5">
          <Link href="/about">
            About Us
          </Link></m.div><m.div whileHover={{scale: 1.1}} className="mb-5">
          <Link href="/services">
            Service
          </Link></m.div><m.div whileHover={{scale: 1.1}} className="mb-5">
          <Link href="/resume">
        ...
        <div className="text-xl flex flex-col">
          ...
          <Link href="https://bkdhanush.netlify.app" className="mb-7">
            bkdhanush.netlify.app
          </Link>
        ...
        <div className="text-xl flex flex-col">
          ...
          <m.div className="flex justify-between bg-white rounded-xl items-center cursor-pointer" whileHover={{scale:1.1}}>
            <p className="text-light-black text-base px-3.5 pl-[13px]">Email Us</p>
